...
// this function creates a three-column table and adds it to the screen
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">Toplam Yazı Sayısı  ' + postTitle.length + ' posts<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">Toplam ' + numDisplayed + ' posts labeled \'';
